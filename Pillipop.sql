...
INSERT INTO REPLY VALUES(SEQ_REPLY_CNum.NEXTVAL, 1, 1, 'twoswim98@naver.com', '수영', '댓글 인사', DEFAULT, DEFAULT, DEFAULT);
...
VALUES(2, 243243, '약1' , '항진제', '이미지', '20221001', '20221101', DEFAULT, DEFAULT, DEFAULT, '3', '메모1');

--INSERT INTO MYMEDICINE(u_no, itemSeq, itemName, itemEffect, itemImage, itemStart, itemEnd, itemCycle1, itemCycle2, itemCycle3, itemNum, memo)
--VALUES(2, 348328, '약2' , '항바이러스제', '이미지', '20220101', '20221212', DEFAULT, DEFAULT, DEFAULT, '1', '메모2');
